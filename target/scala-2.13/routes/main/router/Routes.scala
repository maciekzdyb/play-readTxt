...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """upload""", """controllers.HomeController.upload(request:Request)"""),
  ...
  // @LINE:9
  private[this] lazy val controllers_HomeController_upload3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("upload")))
  )
  private[this] lazy val controllers_HomeController_upload3_invoker = createInvoker(
    
    (req:play.mvc.Http.Request) =>
      HomeController_0.upload(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "upload",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:9
    case controllers_HomeController_upload3_route(params@_) =>
      call { 
        controllers_HomeController_upload3_invoker.call(
          req => HomeController_0.upload(req))
      }
